<html>
    ...
    <body>
        <?php
            if (isset($_POST["first"]) && isset($_POST["last"]) && isset($_POST["username"]) && isset($_POST["password"]) && isset($_POST["email"]) && isset($_POST["ssn"]) && isset($_POST["phone"]) && isset($_POST["lstate"]) && isset($_POST["license"]) && isset($_POST["address"]) && isset($_POST["city"]) && isset($_POST["state"]) && isset($_POST["zip"])) {
                ...
                $sql = "INSERT INTO registrations (username, password, fname, lname, email, address, address2, phone, ssn, state, lstate, license, city, zip) VALUES ('$username', '$password', '$first', '$last', '$email', '$address', '$address2', '$phone', '$ssn', '$state', '$lstate', '$license', '$city', '$zip')";
